...
describe('railgun-smart-wallet-v2.1', () => {
  ...
  test('Should handle Nullified event', () => {
    ...
    const expectedIDs = [
      '0x00000000000000000000000000000000000000000000000000000000000007d00000000000000000000000000000000000000000000000000000000000003000',
      '0x00000000000000000000000000000000000000000000000000000000000007d00000000000000000000000000000000000000000000000000000000000004000',
    ];
